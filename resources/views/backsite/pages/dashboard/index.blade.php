                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ asset('PurpleAdmin') }}/assets/images/faces/face1.jpg" class="me-2" alt="image"> David
                                            Grey
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('PurpleAdmin') }}/assets/images/faces/face2.jpg" class="me-2" alt="image"> Stella
                                            Johnson
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('PurpleAdmin') }}/assets/images/faces/face3.jpg" class="me-2" alt="image"> Marina
                                            Michel
                                        </td>
...
@push('script')
    ...
    <script src="{{ asset('PurpleAdmin') }}/assets/js/chart.js"></script>
